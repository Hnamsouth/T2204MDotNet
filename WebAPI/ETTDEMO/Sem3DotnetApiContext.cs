...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Brand>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ__brands__72E12F1B0FD43164").IsUnique();
        ...
        modelBuilder.Entity<Category>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ__categori__72E12F1B5D613479").IsUnique();
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ__products__72E12F1B313B3BD1").IsUnique();
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.HasIndex(e => e.Email, "UQ__users__AB6E61647149C73B").IsUnique();
            ...
            entity.HasIndex(e => e.Username, "UQ__users__F3DBC57222552708").IsUnique();
